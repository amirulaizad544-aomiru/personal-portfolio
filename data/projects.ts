...
export const projects: Project[] = [
  ...
  },
  {
    ...
    categoryLabel: "AI / RAG / Backend",
    categories: ["AI", "Software"],
    featured: true,
    accent: "#22d3ee",
    summary:
      "A small RAG experiment using the Gemini API to identify questions and select the most relevant context from retrieved information with Top-K retrieval.",
    technologies: ["Python", "Gemini API", "RAG concepts"],
    image: null,
    repoUrl: null,
    demoUrl: null,

    overview:
      "A small Retrieval-Augmented Generation experiment that uses the Gemini API to help identify questions and select relevant context from retrieved information. It is a learning experiment, not a large-scale production RAG system.",
    problem:
      "Given a question and a set of retrieved context, choose which pieces of context are actually relevant.",
    solution:
      "A Python experiment that uses the Gemini API together with a Top-K retrieval approach to pick the most relevant context.",
    features: [
      "Question identification with the Gemini API",
      "Relevant context selection from retrieved information",
      "Top-K retrieval approach",
    ],
    demonstrates: [
      "LLM APIs",
      "Retrieval",
    ...
    contribution: "Built this small experiment myself.",
    architecture: [
      { layer: "Language", detail: "Python." },
      { layer: "Model", detail: "Gemini API." },
      { layer: "Retrieval", detail: "Retrieved context narrowed down with Top-K selection." },
    ],
    screenshots: [],
    challenges: null,
    learned: null,
  ...
  },
  {
    ...
    title: "Google Cloud & Automation Work",
    categoryLabel: "Cloud / Automation / Developer Tools",
    categories: ["Cloud", "Automation"],
    featured: false,
    accent: "#93c5fd",
    summary:
      "A collection of practical cloud and automation work across Google Cloud, Python and browser tooling. Not a single product.",
    technologies: [
    ...
    overview:
      "This is a collection of practical engineering and automation work rather than one product. It spans Google Cloud services, browser automation and data processing in Python, and productivity tooling.",
    problem: null,
    solution: null,
    features: [
      "Google Chrome / Google Extensions integration",
      "Calling GCP Cloud Functions",
      "BigQuery integration",
      "Data scraping",
      "Browser automation",
      "Data processing with Pandas",
      "Cloud resource cleanup and auditing",
      "API integration",
      "Productivity tools",
    ],
    contribution: null,
